...
let foodItems = [
  { id: 1, name: 'Pastitsio', count: 0 },
  { id: 2, name: 'Moussaka', count: 0 },
  { id: 3, name: 'Potatoes', count: 0 },
  { id: 4, name: 'Chicken', count: 0 },
  { id: 5, name: 'Lamb', count: 0 },
  { id: 6, name: 'Rice', count: 0 },
  { id: 7, name: 'Beans', count: 0 },
  { id: 8, name: 'Dolmades', count: 0 },
  { id: 9, name: 'Orzo Pasta', count: 0 },
  { id: 10, name: 'Fish - Plaki', count: 0 }
];
let nextId = 3;
